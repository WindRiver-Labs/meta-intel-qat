...
SRC_URI = "https://downloadmirror.intel.com/649693/QAT.L.4.15.0-00011.tar.gz;subdir=qat17 \
           ...
           file://qat17_4.15-qat-add-install-target-and-add-folder.patch \
           file://qat17_4.15-qat-use-static-lib-for-linking.patch \
           file://qat17_4.15-Link-driver-with-object-files.patch \
          "

do_fetch[depends] += "virtual/kernel:do_shared_workdir"

SRC_URI[md5sum] = "3372e176bba78d8a4057cca4381b5ae5"
SRC_URI[sha256sum] = "036a87f8c337a3d7a8f6e44e39d9767bb88b3b7866ee00886237d454a628aa56"
